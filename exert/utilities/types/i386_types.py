...
on_sys_fadvise64_64_enter_t: Callable[['CPUState', int, int, int, int, int], None]
on_sys_fadvise64_64_return_t: Callable[['CPUState', int, int, int, int, int], None]
...
on_sys_get_thread_area_enter_t: Callable[['CPUState', int, int], None]
on_sys_get_thread_area_return_t: Callable[['CPUState', int, int], None]
...
on_sys_lstat_enter_t: Callable[['CPUState', int, int, int], None]
on_sys_lstat_return_t: Callable[['CPUState', int, int, int], None]
...
on_sys_mmap_pgoff_enter_t: Callable[['CPUState', int, int, int, int, int, int, int], None]
on_sys_mmap_pgoff_return_t: Callable[['CPUState', int, int, int, int, int, int, int], None]
...
on_sys_old_getrlimit_enter_t: Callable[['CPUState', int, int, int], None]
on_sys_old_getrlimit_return_t: Callable[['CPUState', int, int, int], None]
on_sys_old_mmap_enter_t: Callable[['CPUState', int, int], None]
on_sys_old_mmap_return_t: Callable[['CPUState', int, int], None]
on_sys_old_readdir_enter_t: Callable[['CPUState', int, int, int, int], None]
on_sys_old_readdir_return_t: Callable[['CPUState', int, int, int, int], None]
on_sys_old_select_enter_t: Callable[['CPUState', int, int], None]
on_sys_old_select_return_t: Callable[['CPUState', int, int], None]
on_sys_oldumount_enter_t: Callable[['CPUState', int, int], None]
on_sys_oldumount_return_t: Callable[['CPUState', int, int], None]
on_sys_olduname_enter_t: Callable[['CPUState', int, int], None]
on_sys_olduname_return_t: Callable[['CPUState', int, int], None]
...
on_sys_set_thread_area_enter_t: Callable[['CPUState', int, int], None]
on_sys_set_thread_area_return_t: Callable[['CPUState', int, int], None]
...
on_sys_sgetmask_enter_t: Callable[['CPUState', int], None]
on_sys_sgetmask_return_t: Callable[['CPUState', int], None]
...
on_sys_signal_enter_t: Callable[['CPUState', int, int, int], None]
on_sys_signal_return_t: Callable[['CPUState', int, int, int], None]
...
on_sys_sigreturn_enter_t: Callable[['CPUState', int], None]
on_sys_sigreturn_return_t: Callable[['CPUState', int], None]
...
on_sys_ssetmask_enter_t: Callable[['CPUState', int, int], None]
on_sys_ssetmask_return_t: Callable[['CPUState', int, int], None]
on_sys_stat64_enter_t: Callable[['CPUState', int, int, int], None]
on_sys_stat64_return_t: Callable[['CPUState', int, int, int], None]
on_sys_stat_enter_t: Callable[['CPUState', int, int, int], None]
on_sys_stat_return_t: Callable[['CPUState', int, int, int], None]
...
on_sys_vm86_enter_t: Callable[['CPUState', int, int, int], None]
on_sys_vm86_return_t: Callable[['CPUState', int, int, int], None]
on_sys_vm86old_enter_t: Callable[['CPUState', int, int], None]
on_sys_vm86old_return_t: Callable[['CPUState', int, int], None]
...
on_sys_waitpid_enter_t: Callable[['CPUState', int, int, int, int], None]
on_sys_waitpid_return_t: Callable[['CPUState', int, int, int, int], None]
