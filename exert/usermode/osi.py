#created a boilerplate for the OSI files. This isn't very optimized but hopefully this should give a good idea of what to expect?
#first line thing
class HeaderLine():
...
#name
class Name():
    def __init__(self, name = '4.4.0-98-generic|#121-Ubuntu SMP Tue Oct 10 14:24:03 UTC 2017|x86_64'):
        self.name = name
...
#task
class Task():
    def __init__(self, per_cpu_offsets_addr = 18446744071594801600, per_cpu_offset_0_addr = 18446744071594856448, current_task_addr = 54272, init_addr = 18446744071593596160, size = 6848, tasks_offset = 848, pid_offset = 1096,
tgid_offset = 1100, group_leader_offset = 1160, thread_group_offset = 1272, real_parent_offset = 1112, parent_offset = 1120, mm_offset = 928, stack_offset = 8, real_cred_offset = 1520, cred_offset = 1528, comm_offset = 1536, comm_size = 16, files_offset = 1600, start_time_offset = 1408):
...
#mm
class MM():
    def __init__(self, size = 460, mmap_offset = 0, pgd_offset = 32, arg_start_offset = 156, start_brk_offset = 144, brk_offset = 148, start_stack_offset = 152):
        self.size = size
...
#vma
class VMA():
    def __init__(self, size = 100, vm_mm_offset = 32, vm_start_offset = 0, vm_end_offset = 4, vm_next_offset = 8, vm_flags_offset = 44, vm_file_offset = 84):
        self.size = size
...
#fs
class FS():
    def __init__(self, f_path_dentry_offset = 12, f_path_mnt_offset = 8, f_pos_offset = 64, fdt_offset = 20, fdtab_offset = 24, fd_offset = 4):
...
#path
class Path():
    def __init__(self, d_name_offset = 20, d_iname_offset = 36, d_parent_offset = 16, d_op_offset = 80, d_dname_offset = 32, mnt_root_offset = 0, mnt_parent_offset = -8, mnt_mountpoint_offset = -4):
